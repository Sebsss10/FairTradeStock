...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    <h1 class="mb-4">FairTradeStock </h1>
                    <p class="mb-4">FairTradeStock es un gestor de inventario que facilita el manejo y control de
                        productos de manera eficiente y precisa. Con su plataforma intuitiva, permite a las empresas
                        rastrear el inventario en tiempo real, optimizar el almacenamiento y agilizar los procesos
                        logísticos.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-5">
                    ...
                    <div class="bg-secondary" style="padding: 30px;">
                        <h4 class="font-weight-bold mb-3">Automatización de Inventarios con FairTradeStock</h4>
                        <p>La automatización es la clave para una gestión de inventarios moderna y eficiente. Con
                            FairTradeStock, las empresas pueden automatizar el seguimiento y la reposición de productos,
                            minimizando errores humanos y mejorando la precisión. Descubre cómo nuestra tecnología
                            innovadora puede transformar tu negocio y llevar tu gestión de inventarios al siguiente
                            nivel.
                            <br>
                            <br>
                        </p>
                ...
                <div class="col-md-6 mb-5">
                    ...
                    <div class="bg-secondary" style="padding: 30px;">
                        <h4 class="font-weight-bold mb-3">Integración de FairTradeStock en tu Negocio</h4>
                        <p>Implementar un nuevo sistema de gestión de inventarios puede parecer una tarea
                            desalentadora, pero con FairTradeStock, es más sencillo de lo que piensas. Nuestro
                            equipo de expertos está listo para ayudarte en cada paso del proceso, asegurando una
                            transición suave y sin problemas. Aprende más sobre cómo FairTradeStock puede integrarse
                            fácilmente en tu negocio y empezar a ver resultados inmediatos. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                <h1 class="mb-4">Precio de FairTradeStock</h1>
            </div>
            <div class="row">
                    ...
                    <div class="bg-primary py-5 px-4 px-sm-5">
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-0 p-4" placeholder="Asunto" required="required" id="asunto" name="asunto" required>
                            </div>
                            <div class="form-group">
