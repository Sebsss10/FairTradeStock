...
<div class="container" style="margin: auto;">
    ...
    <form id="categoryForm" method="post" action="insertar_categorias.php" style="display: none;">
        <div>
            ...
            <input type="text" id="idCat" name="idCat" required pattern="[0-9]+" title="Ingrese solo números" required disabled>
        </div>
        <div>
...
$(document).ready(function() {
    ...
    $('#showFormBtn').on('click', function() {
        ...
        $('#idCat').val(''); // Asegúrate de limpiar el ID de salida
    });
...
$('#btnExportar').on('click', function() {
    ...
    var filename = 'Categorias_' + formattedDate + '.xlsx';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#btnExportarPDF').on('click', function() {
        ...
        // Encabezado del PDF
        doc.setFontSize(18);
        doc.text('Reporte de Categorias', 14, 22);
        ...
        var filename = 'Categorias_' + formattedDate + '.pdf';
        doc.save(filename);
    });
});
