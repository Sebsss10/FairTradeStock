...
<div class="container" style="margin: auto;">
    ...
    <form id="entradaForm" style="display: none;">
        <div>
            ...
            <input type="text" id="idEntrada" name="idEntrada" required disabled>
        </div>
        <div>
...
<script>
    ...
    $('#showFormBtn').on('click', function() {
            ...
            $('#idEntrada').val(''); // Asegúrate de limpiar el ID de entrada
        });

    // Interceptar el envío del formulario para insertar una nueva entrada
...
$('#btnExportar').on('click', function() {
    ...
    var filename = 'Entradas_' + formattedDate + '.xlsx';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#btnExportarPDF').on('click', function() {
        ...
        // Encabezado del PDF
        doc.setFontSize(18);
        doc.text('Reporte de Entradas', 14, 22);
        ...
        var filename = 'Entradas_' + formattedDate + '.pdf';
        doc.save(filename);
    });
});
