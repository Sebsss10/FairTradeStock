...
<div class="container" style="margin: auto;">
    ...
    <form id="providerForm" method="post" action="insertar_proveedor.php" style="display: none;">
        <div>
            ...
            <input type="text" id="idPr" name="idPr" required pattern="[0-9]+" title="Ingrese solo números" required disabled>
        </div>
        <div>
...
$(document).ready(function() {
    ...
    $('#showFormBtn').on('click', function() {
        ...
        $('#idPr').val(''); // Asegúrate de limpiar el ID de salida
    });
...
$('#btnExportar').on('click', function() {
    ...
    var filename = 'Proveedores_' + formattedDate + '.xlsx';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#btnExportarPDF').on('click', function() {
        ...
        var filename = 'Proveedores_' + formattedDate + '.pdf';
        doc.save(filename);
    });
});
</script>
