<div class="container" style="margin: auto;">
    <div class="table_header">
        ...
        <h2>Usuarios</h2>
        <button id="showFormBtn"><i class="fas fa-folder-plus"></i> Crear nuevo Usuario</button>
...
<script>
  $(document).ready(function() {
    ...
    $('#showFormBtn').on('click', function() {
        ...
        $('#usuario').val(''); // Asegúrate de limpiar el ID de salida
    });
...
$('#btnExportar').on('click', function() {
    ...
    var filename = 'Usuarios_' + formattedDate + '.xlsx';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#btnExportarPDF').on('click', function() {
        ...
        var filename = 'Usuarios_' + formattedDate + '.pdf';
        doc.save(filename);
    });
});
